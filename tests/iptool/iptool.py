...
colum2 = [
    ...
    [sg.Button('DHCP', pad=(10, 22), size=(18, 1))], [
        sg.Text('ATTENTION : \nDisable Wifi Connection and Connect RJ45 cable ', size=(26, 3), justification='center',
                text_color='red',
...
layout = [
    ...
    [sg.Frame('Console Reports ', [[sg.Button('SHOW IPs', pad=(7, 22), size=(18, 1))],
                                   [sg.Output(size=(61, 11), key='-OUTPUT-')]], title_color='#00226F', )],
    [sg.Frame('IPs Info ', [
    ], title_color='#00226F', )],
